...
def main():
    data = clean_and_prepare()  # obtain a pandas data frame which has all the relevant records
...
def clean_and_prepare():
    ...
    # cln.clean('data_stocks.csv')
    #
    #  we have already cleaned the dataset as the original file was too large

    # Read clean csv data into a pandas dataframe
    data = pd.read_csv('data_stocks_clean.csv')

    # Compute new features to be fed to Neural Network
